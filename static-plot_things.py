...
for filename in glob.glob(path + 'T*.dat'):
    data = pd.read_csv(filename, comment = '#', delimiter = ' ', names = colnames_static, index_col = False)
...
plt.xlabel(r'$b$')
plt.ylabel(r'$f_c$')
plt.legend(loc='upper right', ncol = 2, edgecolor = 'black', framealpha=0.5, prop={'size': 12})
plt.savefig('static-cooperation_versus_b-per_occupation.png', dpi=600, bbox_inches='tight')
...
plt.savefig('static-variance_versus_b-per_occupation.png', dpi=400, bbox_inches='tight')
